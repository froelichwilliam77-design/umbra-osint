...
4. **`oracles.yaml`** — silent email registration oracles (no SMTP, no password-reset mail). v1.2.0 shipped 53; current registry is **161** Holehe-style signup / login-precheck / public-API checks.

Handle sites: **1003** unique (717 WMN + 265 Sherlock overlay + 40 curated; 963 clearnet / 40 NSFW).

...
4. **`oracles.yaml`** — silent email registration oracles (no SMTP, no password-reset mail).

v1.2.0 ships **1003** unique handle sites (717 WMN + 265 Sherlock overlay + 40 curated; 963 clearnet / 40 NSFW).

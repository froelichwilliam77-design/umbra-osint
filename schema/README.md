...
Umbra loads five schema layers:
...
3. **`maigret-overlay.json`** — Maigret platforms not already in WMN/Sherlock. Full profile only in practice (lean still ranks then caps).
